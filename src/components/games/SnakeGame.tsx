...
const SnakeGame: React.FC<SnakeGameProps> = ({ className = "" }) => {
    ...
    const gameStep = useCallback(() => {
        ...
        draw();
    }, [score, highScore, draw, generateFood]);
    ...
    return (
        <div className={`flex flex-col items-center justify-center h-full bg-[#0a0a0a] ${className}`}>
            {/* Score bar */}
                        ...
                        <div className="text-center">
                            ...
                            {gameState === "idle" && (
                                <>
                                    ...
                                    <p className="text-gray-400 mb-4 text-sm">Use WASD or arrow keys</p>
                                </>
                            )}
                            <button
                                onClick={startGame}
